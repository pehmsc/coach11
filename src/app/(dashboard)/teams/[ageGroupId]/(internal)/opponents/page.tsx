...
import { OpponentsListSection } from "@/components/team-hub/OpponentsListSection";
import { useAgeGroupName } from "@/hooks/useAgeGroupName";

type PageParams = { ageGroupId: string };

export default function TeamOpponentsListPage({
  params,
}: {
      ...
      >
        <Breadcrumb
          items={[
            ...
            { label: "Adversários", shortLabel: "Adv." },
          ]}
        />
      </StickyBackLink>

      <div className="max-w-5xl mx-auto px-4 py-5">
        <h1 className="text-xl font-bold text-slate-900 mb-4">Adversários</h1>
        <OpponentsListSection ageGroupId={ageGroupId} />
      </div>
    </div>
  );
}
